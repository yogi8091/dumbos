...
// var channel = fabric_client.newChannel('aslimedicinechannel');
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	return fabric_client.getUserContext('retailerUser', true);
}).then((user_from_store) => {
	if (user_from_store && user_from_store.isEnrolled()) {
		console.log('Successfully loaded retailerUser from persistence');
		member_user = user_from_store;
	} else {
		throw new Error('Failed to get retailerUser.... run registerUser.js');
	}
	...
	var request = {chaincodeId: 'aslimedicinecc',
		fcn: 'requestLC',
		args: [req.body.lcId, req.body.expiryDate, req.body.retailer, req.body.distributor, req.body.manufacturer, req.body.amount],
...
function issueLC(req, res) {
	...
	Fabric_Client.newDefaultKeyValueStore({ path: store_path
		...
		// get the enrolled user from persistence, this user will sign all requests
		return fabric_client.getUserContext('distributorUser', true);
	}).then((user_from_store) => {
		if (user_from_store && user_from_store.isEnrolled()) {
			console.log('Successfully loaded distributorUser from persistence');
			member_user = user_from_store;
		} else {
			throw new Error('Failed to get distributorUser.... run registerUser.js');
		}
...
// Get current state of LC using Distributor user
