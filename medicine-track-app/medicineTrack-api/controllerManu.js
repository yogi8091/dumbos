...
return{
	get_all_drug: function(req, res){
        ...
        get_hist_drug: function(req, res){
                console.log("getting drug history from database: ");
                ...
                Fabric_Client.newDefaultKeyValueStore({ path: store_path
                    ...
                    // queryHistDrug - requires no arguments , ex: args: [''],
                    const request = {
                        chaincodeId: 'aslimedicinecc',
                        txId: tx_id,
                        fcn: 'queryHistDrug',
	...
	add_drug: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    if(results && results[1] && results[1].event_status === 'VALID') {
		        ...
		        // YOGI : res.send(tx_id.getTransactionID());
		    } else {
