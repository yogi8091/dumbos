...
1. cd hlf-trade-finance
2. ./setup.sh (With this you will create the channel genesis block, add the peer0 to the channel created and instantiate aslimedicine chaincode.) 
...
2. "AsliMedicineOrgOrdererGenesis -outputBlock ./config/genesis.block" 
3. "AsliMedicineOrgChannel -outputCreateChannelTx ./config/aslimedicinechannel.tx -channelID aslimedicinechannel". 
...
1. cd hlf-trade-finance/aslimedicine-api
2. npm install
3. rm hfc-key-store/*
...
- To check this application specific swagger file go to:  hlf-trade-finance/aslimedicine-api/swagger.json 
...
### Request LC (Letter of Credit)
  1. URL -> http://localhost:3000/aslimedicine/requestLC
  2. Http Method -> Post
  ...
  4. Input->
  {
	...
	"retailer": "buyerUser",
	"distributor": "bankUser",
	"manufacturer": "sellerUser",
	"amount": "100000"
  }
  5. Output-> 
  {
...
### Issue LC (Letter of Credit)
 ...
 1. URL -> http://localhost:3000/aslimedicine/issueLC
 2. Http Method -> Post
 3. content-type: application/json
 4. Input->
  {
...
### Accept LC (Letter of Credit)
 1. URL -> http://localhost:3000/aslimedicine/acceptLC
 2. Http Method -> Post
 3. content-type: application/json
 4. Input->
  {
...
### Get LC Details 
 1. URL -> http://localhost:3000/aslimedicine/getLC
 2. Http Method -> Post
 3. content-type: application/json
 4. Input->
 {
...
### Get LC History 
 1. URL -> http://localhost:3000/aslimedicine/getLCHistory
 2. Http Method -> Post
 3. content-type: application/json
 4. Input->
  {
